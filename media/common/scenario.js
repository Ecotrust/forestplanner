...
function scenarioFormViewModel(options) {
    var self = this;
    var colors = [
        '#1f78b4', '#ffffb3', '#33a02c', '#fb9a99', '#ff7f00',
        '#cab2d6', '#6afd9a', '#ffff99', '#b15928',
        '#FB9A99', '#BEBADA', '#FB8072', '#80B1D3', '#FDB462', '#B3DE69', '#FCCDE5',
...
function scenarioViewModel(options) {
    ...
    self.toggleFeature = function(f, e) {
        ...
        if (removed.length === 0) {
            ...
            $('#revenue-select-scenario1 option:last-child').attr('selected', 'selected');
        }
