...
WORKING_DIR="/usr/local/apps/forestplanner/lot/landmapper/data/population_2021"
SHP="$WORKING_DIR/pop_places_point.shp"
FINAL="$WORKING_DIR/OR_POPULATION_2021.sql"

SRID=3857
table_name='landmapper_populationpoint'
database_name='disco'
db_user='postgres'
...
FIELDMAP="$thisdir/population_field_map.json"

# Probably won't need to touch these if running from root project dir
TMP="$WORKING_DIR/population_planning_grid.sql"
