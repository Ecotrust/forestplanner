...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stand.nn_savetime'
        db.add_column('trees_stand', 'nn_savetime',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)

        # Adding field 'Stand.rast_savetime'
        db.add_column('trees_stand', 'rast_savetime',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stand.nn_savetime'
        db.delete_column('trees_stand', 'nn_savetime')

        # Deleting field 'Stand.rast_savetime'
        db.delete_column('trees_stand', 'rast_savetime')
