...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stand.locked_cond_id'
        db.add_column('trees_stand', 'locked_cond_id',
                      self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stand.locked_cond_id'
        db.delete_column('trees_stand', 'locked_cond_id')
