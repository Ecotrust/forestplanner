...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('trees_membership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('applicant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.CarbonGroup'])),
        ...
        db.send_create_signal('trees', ['Membership'])

        # Adding unique constraint on 'Membership', fields ['applicant', 'group']
        db.create_unique('trees_membership', ['applicant_id', 'group_id'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Membership', fields ['applicant', 'group']
        db.delete_unique('trees_membership', ['applicant_id', 'group_id'])

        # Deleting model 'Membership'
        db.delete_table('trees_membership')
