...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.input_age_class'
        db.alter_column('trees_scenario', 'input_age_class', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_site_diversity'
        db.alter_column('trees_scenario', 'input_site_diversity', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Scenario.input_target_boardfeet'
        db.alter_column('trees_scenario', 'input_target_boardfeet', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Scenario.input_age_class'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.input_age_class' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Scenario.input_site_diversity'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.input_site_diversity' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Scenario.input_target_boardfeet'
        raise RuntimeError("Cannot reverse this migration. 'Scenario.input_target_boardfeet' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 17, 26, 52, 732959)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 17, 26, 52, 732824)'}),
