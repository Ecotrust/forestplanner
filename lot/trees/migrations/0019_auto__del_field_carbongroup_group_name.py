...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CarbonGroup.group_name'
        db.delete_column('trees_carbongroup', 'group_name')


    def backwards(self, orm):
        # Adding field 'CarbonGroup.group_name'
        db.add_column('trees_carbongroup', 'group_name',
