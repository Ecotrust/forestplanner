...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForestProperty.geometry_final'
        db.alter_column('trees_forestproperty', 'geometry_final', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=3857, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ForestProperty.geometry_final'
        raise RuntimeError("Cannot reverse this migration. 'ForestProperty.geometry_final' and its values cannot be restored.")
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 13, 42, 49, 471049)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 9, 13, 42, 49, 470916)'}),
