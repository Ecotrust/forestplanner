...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'TimberPrice', fields ['variant', 'timber_type']
        db.create_unique('trees_timberprice', ['variant_id', 'timber_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'TimberPrice', fields ['variant', 'timber_type']
        db.delete_unique('trees_timberprice', ['variant_id', 'timber_type'])
