...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('trees_scenario', (
            ...
            ('input_target_boardfeet', self.gf('django.db.models.fields.FloatField')()),
            ('input_target_carbon', self.gf('django.db.models.fields.FloatField')()),
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 24, 15, 15, 53, 179574)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 24, 15, 15, 53, 179454)'}),
