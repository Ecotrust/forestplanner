...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stand.elevation'
        db.add_column('trees_stand', 'elevation',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stand.slope'
        db.add_column('trees_stand', 'slope',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Stand.aspect'
        db.add_column('trees_stand', 'aspect',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Stand.elevation'
        db.delete_column('trees_stand', 'elevation')

        # Deleting field 'Stand.slope'
        db.delete_column('trees_stand', 'slope')

        # Deleting field 'Stand.aspect'
        db.delete_column('trees_stand', 'aspect')
