...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Scenario.input_property'
        db.add_column('trees_scenario', 'input_property', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['trees.ForestProperty']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Scenario.input_property'
        db.delete_column('trees_scenario', 'input_property_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 11, 42, 36, 790918)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 8, 27, 11, 42, 36, 790789)'}),
        ...
        'trees.scenario': {
            ...
            'input_target_carbon': ('django.db.models.fields.FloatField', [], {}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': "'255'"}),
            'object_id': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
