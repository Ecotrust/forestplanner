...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ConditionVariantLookup'
        db.create_table('trees_conditionvariantlookup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cond_id', self.gf('django.db.models.fields.BigIntegerField')(db_index=True)),
            ('variant_code', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('trees', ['ConditionVariantLookup'])


    def backwards(self, orm):
        # Deleting model 'ConditionVariantLookup'
        db.delete_table('trees_conditionvariantlookup')
