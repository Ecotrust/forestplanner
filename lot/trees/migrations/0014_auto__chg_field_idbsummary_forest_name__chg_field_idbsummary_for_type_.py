...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdbSummary.forest_name'
        db.alter_column(u'idb_summary', 'forest_name', self.gf('django.db.models.fields.CharField')(max_length=510, null=True))

        # Changing field 'IdbSummary.for_type_secdry_name'
        db.alter_column(u'idb_summary', 'for_type_secdry_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'IdbSummary.fia_forest_type_name'
        db.alter_column(u'idb_summary', 'fia_forest_type_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))

        # Changing field 'IdbSummary.for_type_name'
        db.alter_column(u'idb_summary', 'for_type_name', self.gf('django.db.models.fields.CharField')(max_length=60, null=True))


    def backwards(self, orm):
        
        # Changing field 'IdbSummary.forest_name'
        db.alter_column(u'idb_summary', 'forest_name', self.gf('django.db.models.fields.CharField')(default='', max_length=510))

        # Changing field 'IdbSummary.for_type_secdry_name'
        db.alter_column(u'idb_summary', 'for_type_secdry_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

        # Changing field 'IdbSummary.fia_forest_type_name'
        db.alter_column(u'idb_summary', 'fia_forest_type_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60))

        # Changing field 'IdbSummary.for_type_name'
        db.alter_column(u'idb_summary', 'for_type_name', self.gf('django.db.models.fields.CharField')(default='', max_length=60))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 8, 52, 17, 995190)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 6, 8, 52, 17, 995042)'}),
        ...
        'trees.plotlookup': {
            'Meta': {'ordering': "['name']", 'object_name': 'PlotLookup'},
