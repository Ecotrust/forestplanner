...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Stand.cond_id'
        db.add_column('trees_stand', 'cond_id', self.gf('django.db.models.fields.BigIntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Stand.cond_id'
        db.delete_column('trees_stand', 'cond_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 11, 22, 47, 53247)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 11, 22, 47, 53112)'}),
