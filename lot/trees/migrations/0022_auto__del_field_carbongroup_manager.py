...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CarbonGroup.manager'
        db.delete_column('trees_carbongroup', 'manager_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'CarbonGroup.manager'
        raise RuntimeError("Cannot reverse this migration. 'CarbonGroup.manager' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'CarbonGroup.manager'
        db.add_column('trees_carbongroup', 'manager',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='manager_set', to=orm['auth.User']),
                      keep_default=False)
