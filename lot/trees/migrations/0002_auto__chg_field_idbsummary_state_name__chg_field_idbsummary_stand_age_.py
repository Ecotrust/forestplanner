...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IdbSummary.state_name'
        db.alter_column(u'idb_summary', 'state_name', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))

        # Changing field 'IdbSummary.stand_age_even_yn'
        db.alter_column(u'idb_summary', 'stand_age_even_yn', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

        # Changing field 'IdbSummary.fvs_variant'
        db.alter_column(u'idb_summary', 'fvs_variant', self.gf('django.db.models.fields.CharField')(max_length=4, null=True))

        # Changing field 'IdbSummary.halfstate_name'
        db.alter_column(u'idb_summary', 'halfstate_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'IdbSummary.county_name'
        db.alter_column(u'idb_summary', 'county_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'IdbSummary.plant_assoc_code'
        db.alter_column(u'idb_summary', 'plant_assoc_code', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'IdbSummary.state_name'
        db.alter_column(u'idb_summary', 'state_name', self.gf('django.db.models.fields.CharField')(default='', max_length=40))

        # Changing field 'IdbSummary.stand_age_even_yn'
        db.alter_column(u'idb_summary', 'stand_age_even_yn', self.gf('django.db.models.fields.CharField')(default='', max_length=2))

        # Changing field 'IdbSummary.fvs_variant'
        db.alter_column(u'idb_summary', 'fvs_variant', self.gf('django.db.models.fields.CharField')(default='', max_length=4))

        # Changing field 'IdbSummary.halfstate_name'
        db.alter_column(u'idb_summary', 'halfstate_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'IdbSummary.county_name'
        db.alter_column(u'idb_summary', 'county_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'IdbSummary.plant_assoc_code'
        db.alter_column(u'idb_summary', 'plant_assoc_code', self.gf('django.db.models.fields.CharField')(default='', max_length=20))
