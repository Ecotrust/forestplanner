...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ScenarioStand.offset'
        db.add_column('trees_scenariostand', 'offset',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ScenarioStand.acres'
        db.delete_column('trees_scenariostand', 'acres')

        # Deleting field 'ScenarioStand.offset'
        db.delete_column('trees_scenariostand', 'offset')
