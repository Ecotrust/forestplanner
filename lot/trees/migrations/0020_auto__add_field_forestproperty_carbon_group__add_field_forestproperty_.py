...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ForestProperty.carbon_group'
        db.add_column('trees_forestproperty', 'carbon_group',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.CarbonGroup'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'ForestProperty.shared_scenario'
        db.add_column('trees_forestproperty', 'shared_scenario',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.Scenario'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ForestProperty.carbon_group'
        db.delete_column('trees_forestproperty', 'carbon_group_id')

        # Deleting field 'ForestProperty.shared_scenario'
        db.delete_column('trees_forestproperty', 'shared_scenario_id')
