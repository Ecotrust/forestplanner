...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Stand.rx'
        db.delete_column('trees_stand', 'rx')

        # Deleting field 'Stand.domspp'
        db.delete_column('trees_stand', 'domspp')

        # Adding field 'Stand.strata'
        db.add_column('trees_stand', 'strata', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['trees.Strata'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Stand.rx'
        db.add_column('trees_stand', 'rx', self.gf('django.db.models.fields.CharField')(default='--', max_length=2), keep_default=False)

        # Adding field 'Stand.domspp'
        db.add_column('trees_stand', 'domspp', self.gf('django.db.models.fields.CharField')(default='--', max_length=2), keep_default=False)

        # Deleting field 'Stand.strata'
        db.delete_column('trees_stand', 'strata_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 8, 25, 15, 566290)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 1, 8, 25, 15, 566166)'}),
