...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FVSAggregate', fields ['cond', 'offset', 'var', 'year', 'site', 'rx']
        db.create_unique('trees_fvsaggregate', ['cond', 'offset', 'var', 'year', 'site', 'rx'])


    def backwards(self, orm):
        # Removing unique constraint on 'FVSAggregate', fields ['cond', 'offset', 'var', 'year', 'site', 'rx']
        db.delete_unique('trees_fvsaggregate', ['cond', 'offset', 'var', 'year', 'site', 'rx'])
