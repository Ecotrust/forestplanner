...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Stand.plot'
        db.delete_column('trees_stand', 'plot_id')


    def backwards(self, orm):
        
        # Adding field 'Stand.plot'
        db.add_column('trees_stand', 'plot', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['trees.PlotSummary'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 10, 59, 16, 986415)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 5, 10, 59, 16, 986289)'}),
        ...
        'trees.idbsummary': {
            ...
            'cond_id': ('django.db.models.fields.BigIntegerField', [], {'unique': 'True', 'primary_key': 'True'}),
