...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Scenario.input_rxs'
        db.alter_column('trees_scenario', 'input_rxs', self.gf('trees.models.JSONField')(null=True))

    def backwards(self, orm):

        # Changing field 'Scenario.input_rxs'
        db.alter_column('trees_scenario', 'input_rxs', self.gf('trees.models.JSONField')(default='{}'))
