...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Stand.cost'
        db.add_column('trees_stand', 'cost',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Stand.strata'
        db.alter_column('trees_stand', 'strata_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.Strata'], null=True, on_delete=models.SET_NULL))
        # Deleting field 'Scenario.input_site_diversity'
        db.delete_column('trees_scenario', 'input_site_diversity')


    def backwards(self, orm):
        # Deleting field 'Stand.cost'
        db.delete_column('trees_stand', 'cost')


        # Changing field 'Stand.strata'
        db.alter_column('trees_stand', 'strata_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.Strata'], null=True))
        # Adding field 'Scenario.input_site_diversity'
        db.add_column('trees_scenario', 'input_site_diversity',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)
