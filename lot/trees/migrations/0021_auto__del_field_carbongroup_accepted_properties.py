...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CarbonGroup.accepted_properties'
        db.delete_column('trees_carbongroup', 'accepted_properties')

        # Adding M2M table for field excluded_properties on 'CarbonGroup'
        m2m_table_name = db.shorten_name('trees_carbongroup_excluded_properties')
        ...
        db.create_unique(m2m_table_name, ['carbongroup_id', 'forestproperty_id'])


    def backwards(self, orm):
        # Adding field 'CarbonGroup.accepted_properties'
        db.add_column('trees_carbongroup', 'accepted_properties',
                      self.gf('django.db.models.fields.TextField')(default='[]'),
                      keep_default=False)

        # Removing M2M table for field excluded_properties on 'CarbonGroup'
        db.delete_table(db.shorten_name('trees_carbongroup_excluded_properties'))
    ...
    models = {
        ...
        'trees.carbongroup': {
            ...
            'excluded_properties': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'excludedproperties_set'", 'symmetrical': 'False', 'to': "orm['trees.ForestProperty']"}),
