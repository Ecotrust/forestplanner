...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TimberPrice'
        db.create_table('trees_timberprice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('variant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.FVSVariant'])),
            ('timber_type', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('price', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('trees', ['TimberPrice'])


    def backwards(self, orm):
        # Deleting model 'TimberPrice'
        db.delete_table('trees_timberprice')
