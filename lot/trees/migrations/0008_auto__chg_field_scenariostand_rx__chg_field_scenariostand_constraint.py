...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ScenarioStand.rx'
        db.alter_column('trees_scenariostand', 'rx_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['trees.Rx']))

        # Changing field 'ScenarioStand.constraint'
        db.alter_column('trees_scenariostand', 'constraint_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.SpatialConstraint'], null=True))

    def backwards(self, orm):

        # Changing field 'ScenarioStand.rx'
        db.alter_column('trees_scenariostand', 'rx_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['trees.Rx'], null=True))

        # Changing field 'ScenarioStand.constraint'
        db.alter_column('trees_scenariostand', 'constraint_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['trees.SpatialConstraint']))
